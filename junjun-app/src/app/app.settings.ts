...
export const GALLERY = {
  ...
  images: [
    { src: 'assets/image/Hotel_Room_01.jpg', alt: 'Standard room view', label: 'Standard Room', rank: 1 },
    { src: 'assets/image/Hotel_Room_02.jpg', alt: 'Deluxe suite view', label: 'Deluxe Suite', rank: 2 },
    { src: 'assets/image/Hotel_Room_03.jpg', alt: 'Queen-size bed setup', label: 'Queen Bed', rank: 3 },
    { src: 'assets/image/Hotel_Room_04.jpg', alt: 'Private bathroom', label: 'Bathroom', rank: 4 },
    { src: 'assets/image/Hotel_Room_05.jpg', alt: 'Living and seating area', label: 'Living Area', rank: 5 },
    { src: 'assets/image/Hotel_Room_06.jpg', alt: 'Room amenities and features', label: 'Amenities', rank: 6 },
    { src: 'assets/image/Hotel_Room_07.jpg', alt: 'Room details and decor', label: 'Room Details', rank: 7 },
    { src: 'assets/image/Hotel_Room_08.jpg', alt: 'Comfortable room layout', label: 'Comfort Space', rank: 8 },
    { src: 'assets/image/Hotel_Room_09.jpg', alt: 'Room with warm natural lighting', label: 'Warm Atmosphere', rank: 9 },
    { src: 'assets/image/Hotel_Room_10.jpg', alt: 'Essential amenities provided', label: 'Daily Essentials', rank: 10 },
    { src: 'assets/image/Hotel_Room_11.jpg', alt: 'Well-decorated room interior', label: 'Interior View', rank: 11 },
    { src: 'assets/image/Hotel_Room_12.jpg', alt: 'Comfortable relaxation corner', label: 'Relaxation Area', rank: 12 },
    { src: 'assets/image/Hotel_Room_13.jpg', alt: 'Spacious corner of the suite', label: 'Corner Space', rank: 13 },
    { src: 'assets/image/Hotel_Room_14.jpg', alt: 'Cozy and welcoming setup', label: 'Cozy Setup', rank: 14 },
    { src: 'assets/image/Hotel_Room_15.jpg', alt: 'Bright room with balanced daylight and warm tones', label: 'Bright Daylight View', rank: 15 },
    { src: 'assets/image/Hotel_Room_16.jpg', alt: 'Neat room arrangement emphasizing clean bedding and layout', label: 'Clean Room Layout', rank: 16 },
    { src: 'assets/image/Hotel_Room_17.jpg', alt: 'Comfort-focused angle showing bed and movement space', label: 'Comfort Living Space', rank: 17 },
    { src: 'assets/image/Hotel_Room_18.jpg', alt: 'Room perspective highlighting practical furniture setup', label: 'Practical Interior Setup', rank: 18 },
    { src: 'assets/image/Hotel_Room_19.jpg', alt: 'Calm interior tone suitable for long stays', label: 'Long Stay Friendly', rank: 19 },
    { src: 'assets/image/Hotel_Room_20.jpg', alt: 'Room details showcasing daily-use convenience', label: 'Daily Convenience Details', rank: 20 },
    { src: 'assets/image/Hotel_Room_21.jpg', alt: 'Inviting suite corner with cozy presentation', label: 'Inviting Suite Corner', rank: 21 },
    { src: 'assets/image/Hotel_Room_22.jpg', alt: 'Full room composition for a complete space overview', label: 'Full Room Overview', rank: 22 },
  ],
} as const;
