...
export const GALLERY = {
  ...
  images: [
    ...
    { src: 'assets/image/Hotel_Room_15.jpg', alt: 'Bright room with balanced daylight and warm tones', label: 'Bright Daylight View' },
    { src: 'assets/image/Hotel_Room_16.jpg', alt: 'Neat room arrangement emphasizing clean bedding and layout', label: 'Clean Room Layout' },
    { src: 'assets/image/Hotel_Room_17.jpg', alt: 'Comfort-focused angle showing bed and movement space', label: 'Comfort Living Space' },
    { src: 'assets/image/Hotel_Room_18.jpg', alt: 'Room perspective highlighting practical furniture setup', label: 'Practical Interior Setup' },
    { src: 'assets/image/Hotel_Room_19.jpg', alt: 'Calm interior tone suitable for long stays', label: 'Long Stay Friendly' },
    { src: 'assets/image/Hotel_Room_20.jpg', alt: 'Room details showcasing daily-use convenience', label: 'Daily Convenience Details' },
    { src: 'assets/image/Hotel_Room_21.jpg', alt: 'Inviting suite corner with cozy presentation', label: 'Inviting Suite Corner' },
    { src: 'assets/image/Hotel_Room_22.jpg', alt: 'Full room composition for a complete space overview', label: 'Full Room Overview' },
  ],
} as const;
