...
export const STRINGS = {
  ...
  es: mkLang({
    ...
    aboutP: [
      ...
      "🌆 Ubicación y comodidad diaria\nLa suite ofrece excelente acceso a los barrios más dinámicos de Toronto. Está cerca de Little Italy, Western Hospital, Chinatown y el campus St. George de la Universidad de Toronto. Las paradas de metro y tranvía de la TTC están justo abajo y operan 24 horas, lo que facilita moverse por la ciudad. En la planta baja del edificio hay un restaurante para comidas rápidas (abierto hasta las 4 a.m.). A pocos minutos caminando encontrará Tim Hortons, T&T, McDonald's, Subway, FreshCo, comercios de barrio y también Kensington Market.",
  ...
  ja: mkLang({
    ...
    aboutP: [
      ...
      "🌆 立地と日常の利便性\nリトルイタリー、ウェスタン病院、チャイナタウン、トロント大学セントジョージキャンパスに近く、生活面と移動面のバランスに優れています。TTCの地下鉄とストリートカーの停留所は建物のすぐ下にあり、24時間利用できるため移動もスムーズです。建物1階にはレストランがあり（午前4時まで営業）、手早く食事を済ませたいときにも便利です。徒歩圏内には Tim Hortons、T&T、McDonald's、Subway、FreshCo、周辺店舗、そしてケンジントンマーケットがあります。",
  ...
  ko: mkLang({
    ...
    aboutP: [
      ...
      "🌆 위치와 일상 편의\n숙소는 리틀 이탈리, 웨스턴 병원, 차이나타운, 토론토대학교 세인트 조지 캠퍼스와 가깝습니다. 건물 바로 아래에는 TTC 지하철과 스트리트카 정류장이 있어 24시간 이동이 편리합니다. 건물 1층에는 레스토랑이 있어 간단한 식사도 쉽게 해결할 수 있습니다(오전 4시까지 영업). 도보권에는 Tim Hortons, T&T, McDonald's, Subway, FreshCo, 다양한 로컬 상점, 켄싱턴 마켓이 있습니다.",
  ...
  ar: mkLang({
    ...
    aboutP: [
      ...
      "🌆 الموقع والراحة اليومية\nيقع الفندق بالقرب من ليتل إيطاليا والمستشفى الغربي والحي الصيني وحرم سانت جورج بجامعة تورنتو. محطات مترو وترام TTC موجودة مباشرة في الأسفل ومتاحة على مدار 24 ساعة، مما يجعل التنقل سهلاً. يوجد مطعم في الطابق الأرضي مناسب للوجبات السريعة (مفتوح حتى الساعة 4 صباحاً). كما يمكنكم الوصول سيراً إلى Tim Hortons وT&T وMcDonald's وSubway وFreshCo ومتاجر محلية متعددة، بالإضافة إلى سوق كينسينغتون.",
  ...
  zhHant: mkLang({
    ...
    aboutP: [
      ...
      "🌆 地理位置與日常便利\n旅店鄰近小意大利、西方醫院、唐人街與多倫多大學聖喬治校區。TTC 地鐵與路面電車站就在樓下，且 24 小時可用，交通非常便利。大樓一樓設有餐館（營業至凌晨4時），方便快速用餐。步行即可到達 Tim Hortons、T&T、麥當勞、Subway、FreshCo、周邊商店與肯辛頓市場，生活機能完整。",
  ...
  zh: mkLang({
    ...
    aboutP: [
      ...
      "🌆 位置与日常便利\n旅店靠近小意大利、西方医院、唐人街和多伦多大学圣乔治校区。TTC 地铁与有轨电车站就在楼下，并且 24 小时可用，出行非常方便。大楼一层设有餐馆（营业至凌晨4点），便于快速用餐。步行范围内还有 Tim Hortons、T&T、麦当劳、Subway、FreshCo、多家本地商铺以及肯辛顿市场，生活便利度很高。",
